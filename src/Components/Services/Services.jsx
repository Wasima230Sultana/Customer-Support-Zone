            ...
            <div className="card-body">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className=''>
                        <button className="btn h-7 rounded-2xl bg-[#B9F8CF] text-[#0B5E06]">
                            <div className="w-3 h-3 flex items-center justify-center rounded-full bg-green-500 text-white font-medium text-xs">
                            </div>
                            {customer.status}
                        </button>
                    </div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <p className='text-[#F83044] font-medium text-sm'>
                            {customer.priority}</p>
                    </div>
